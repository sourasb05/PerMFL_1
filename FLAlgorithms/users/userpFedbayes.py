...
from FLAlgorithms.users.userpFedbayesbase import User


class UserpFedBayes(User):
    def __init__(self, numeric_id, train_data, test_data, model, model_name, batch_size, learning_rate, beta, lamda,
                 local_epochs, optimizer, personal_learning_rate, device, output_dim=10):
        super().__init__(numeric_id, train_data, test_data, model, batch_size, learning_rate, beta, lamda,
