...
from FLAlgorithms.optimizers.fedoptimizer import pFedMe_original_Optimizer
from FLAlgorithms.users.userpFedMebase import User
import copy


# Implementation for pFeMe clients

class UserpFedMeoriginal(User):
    def __init__(self,
                device,
                numeric_id,
                train_data,
        ...
        self.optimizer = pFedMe_original_Optimizer(self.model.parameters(), lr=self.personal_learning_rate, lamda=self.lamda)
