...
class Server:
    ...
    def save_results(self):
        ...
        print("exp_no ", self.times)
        # input("press :")
        alg = alg + "_" + str(self.model_name) + "_" + "exp_no_" + str(self.times) + "_" + "_alpha_" + str(self.learning_rate) + \
        "_lambda_" + str(self.lamda) + "_" + "_" + str(self.batch_size) + "b" + "_" + str(self.num_glob_iters) + "GE"  + \
              "_" + str(self.local_epochs) + "LE" + '_' + d1
        # if self.algorithm == "pFedMe":
        #    alg = alg + "_" + str(self.alpha)
        # alg = alg + "_" + str(self.times)
        # Create a directory named "new_dir"
        directory_name = self.algorithm + "/" + self.dataset + "/" + self.model_name
